package com.seu.study.filelistener;
import java.io.File;
...
public class FileListenerDemo extends FileAlterationListenerAdaptor {

    private static final Logger logger = LoggerFactory.getLogger(FileListenerDemo.class);
    ...
    public static void main(String[] args) {
        try {
            ...
            FileAlterationObserver observer = new FileAlterationObserver("/Users/lawlite/dir_test", new FileFilterImpl());
            // 构造收听类 没啥好说的
            FileListenerDemo listener = new FileListenerDemo();
            // 为观察对象添加收听对象
